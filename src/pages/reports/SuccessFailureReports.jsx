...
//         <div className={`w-8 h-8 sm:w-11 sm:h-11 ${iconBg} rounded-full flex items-center justify-center flex-shrink-0`}>
//           {icon}
//         </div>
//         <div className="min-w-0 flex-1">
...
//             <span className={`text-[10px] sm:text-xs font-semibold ${rateColor}`}>{ratePct}</span>
//             <span className="text-[9px] sm:text-xs text-gray-400">vs last 30 days</span>
//             <span className={`text-[10px] sm:text-xs font-semibold flex items-center gap-0.5 ${up ? "text-green-600" : "text-red-500"}`}>
//               {up ? "↑" : "↓"} {changePct}
//             </span>
//           </div>
//         </div>
...
//         <h1 className="text-lg sm:text-xl font-bold text-gray-900">Success / Failure Report</h1>
...
//             <select className="w-full appearance-none pl-2.5 sm:pl-3 pr-7 sm:pr-8 py-1.5 sm:py-2 text-[11px] sm:text-xs text-gray-600 bg-white border border-gray-200 rounded-lg focus:outline-none cursor-pointer hover:border-gray-300">
//               <option>{f}</option>
//             </select>
...
//         <button className="px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white text-[11px] sm:text-xs font-semibold rounded-lg transition-colors">
//           Apply Filter
//         </button>
...
//         <StatCard
//           iconBg="bg-green-50"
//           icon={<svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
//           label="Successful Transactions" value="25,430"
//           ratePct="98.42%" rateColor="text-green-600"
//           changePct="13.2%" changeDir="up"
//         />
//         <StatCard
//           iconBg="bg-red-50"
//           icon={<svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
//           label="Failed Transactions" value="412"
//           ratePct="1.58%" rateColor="text-red-500"
//           changePct="8.7%" changeDir="down"
//         />
...
//         <StatCard
//           iconBg="bg-blue-50"
//           icon={<svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8h6m-5 0a3 3 0 110 6H9l3 3m-3-6h6m6 1a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
//           label="Success Amount" value="₹12.35 Cr"
//           ratePct="98.25%" rateColor="text-green-600"
//           changePct="15.6%" changeDir="up"
//         />
//         <StatCard
//           iconBg="bg-red-50"
//           icon={<svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8h6m-5 0a3 3 0 110 6H9l3 3m-3-6h6m6 1a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
//           label="Failed Amount" value="₹18.90 L"
//           ratePct="1.50%" rateColor="text-red-500"
//           changePct="6.2%" changeDir="down"
//         />
...
//         {/* Success vs Failure Trend */}
//         <div className="flex-1 lg:flex-[7] bg-white rounded-xl border border-gray-100 p-3 sm:p-4">
//           <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
//             <h2 className="text-xs sm:text-sm font-semibold text-gray-800">Success vs Failure Trend</h2>
//             <div className="flex gap-1">
//               {["7D", "30D", "90D"].map(r => (
//                 <button key={r} onClick={() => setTrendRange(r)}
//                   className={`px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-semibold rounded-lg transition-colors ${trendRange === r ? "bg-blue-600 text-white" : "text-gray-500 hover:bg-gray-100"
//                     }`}>{r}</button>
//               ))}
//             </div>
//           </div>
...
//           {/* Legend */}
//           <div className="flex flex-wrap items-center gap-3 sm:gap-5 mb-2 sm:mb-3">
//             {[
//               { color: "#16a34a", label: "Success" },
//               { color: "#dc2626", label: "Failure" },
//               { color: "#f59e0b", label: "Pending" },
//             ].map(l => (
//               <div key={l.label} className="flex items-center gap-1 sm:gap-1.5">
//                 <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full" style={{ background: l.color }} />
//                 <span className="text-[10px] sm:text-xs text-gray-500">{l.label}</span>
//               </div>
//             ))}
//           </div>
...
//                 <YAxis tick={{ fontSize: 9, fill: "#9ca3af" }} axisLine={false} tickLine={false}
//                   tickFormatter={v => v >= 1000 ? `${v / 1000}K` : v} width={30} />
//                 <Tooltip content={<TrendTooltip />} />
//                 <Line type="monotone" dataKey="success" stroke="#16a34a" strokeWidth={2.5}
//                   dot={{ r: 3, fill: "#16a34a", strokeWidth: 0 }} activeDot={{ r: 4 }} name="Success" />
//                 <Line type="monotone" dataKey="failure" stroke="#dc2626" strokeWidth={2}
//                   dot={{ r: 3, fill: "#dc2626", strokeWidth: 0 }} activeDot={{ r: 4 }} name="Failure" />
//                 <Line type="monotone" dataKey="pending" stroke="#f59e0b" strokeWidth={2}
//                   dot={{ r: 3, fill: "#f59e0b", strokeWidth: 0 }} activeDot={{ r: 4 }} name="Pending" />
//               </LineChart>
//             </ResponsiveContainer>
//           </div>
//         </div>
...
//           <h2 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-3">Success vs Failure Distribution</h2>
//           <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-5">
//             {/* Donut */}
//             <div className="relative flex-shrink-0">
//               <div className="h-[140px] w-[140px] sm:h-[170px] sm:w-[170px]">
//                 <ResponsiveContainer width="100%" height="100%">
//                   <PieChart>
//                     <Pie data={distributionData} cx="50%" cy="50%" innerRadius={45} outerRadius={65}
//                       dataKey="value" strokeWidth={2} stroke="#fff" startAngle={90} endAngle={-270}>
//                       {distributionData.map((d, i) => <Cell key={i} fill={d.color} />)}
//                     </Pie>
//                   </PieChart>
...
//               </div>
//               <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
//                 <span className="text-lg sm:text-2xl font-bold text-gray-900">{total.toLocaleString()}</span>
//                 <span className="text-[9px] sm:text-[11px] text-gray-400">Total</span>
//               </div>
//             </div>
//             {/* Legend */}
...
//                   <span className="text-[10px] sm:text-xs text-gray-600 w-14 sm:w-16">{d.name}</span>
...
//           <h2 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-3">Failure Reasons</h2>
//           <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
//             {/* Pie */}
//             <div className="relative flex-shrink-0">
//               <div className="h-[120px] w-[120px] sm:h-[140px] sm:w-[140px]">
//                 <ResponsiveContainer width="100%" height="100%">
//                   <PieChart>
//                     <Pie data={failureReasonData} cx="50%" cy="50%" innerRadius={38} outerRadius={55}
//                       dataKey="value" strokeWidth={2} stroke="#fff">
//                       {failureReasonData.map((d, i) => <Cell key={i} fill={d.color} />)}
//                     </Pie>
//                   </PieChart>
...
//               </div>
//               <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
//                 <span className="text-base sm:text-xl font-bold text-gray-900">412</span>
//                 <span className="text-[9px] sm:text-[10px] text-gray-400">Total Failed</span>
//               </div>
//             </div>
//             {/* Legend */}
...
//                 <div key={d.name} className="flex items-center gap-1.5 sm:gap-2">
//                   <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full flex-shrink-0" style={{ background: d.color }} />
//                   <span className="text-[10px] sm:text-xs text-gray-600 flex-1">{d.name}</span>
//                   <span className="text-[10px] sm:text-xs font-semibold text-gray-800">
//                     {d.pct} ({d.value})
//                   </span>
//                 </div>
...
//             </div>
//           </div>
//           <button className="mt-3 sm:mt-4 flex items-center gap-1 text-[11px] sm:text-xs text-blue-600 font-medium hover:underline">
//             View Failure Reasons Report
...
//         {/* Failure by API */}
//         <div className="flex-1 bg-white rounded-xl border border-gray-100 p-3 sm:p-4">
//           <h2 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-3">Failure by API</h2>
...
//                 {failureByApi.map(r => (
//                   <tr key={r.api} className="border-b border-gray-50 last:border-0">
//                     <td className="py-1.5 sm:py-2.5 text-gray-800 font-medium truncate max-w-[100px] sm:max-w-none">{r.api}</td>
//                     <td className="py-1.5 sm:py-2.5 text-right text-gray-700">{r.failed}</td>
//                     <td className="py-1.5 sm:py-2.5 text-right text-gray-700">{r.amount}</td>
//                     <td className="py-1.5 sm:py-2.5 text-right">
//                       <div className="flex items-center justify-end gap-1 sm:gap-1.5">
//                         <span className="text-gray-700 text-[10px] sm:text-xs">{r.rate}</span>
//                         <div className="w-8 sm:w-12 h-1 sm:h-1.5 bg-gray-100 rounded-full overflow-hidden">
//                           <div className="h-full bg-gray-400 rounded-full" style={{ width: `${r.bar}%` }} />
//                         </div>
//                       </div>
//                     </td>
...
//         <div className="flex-1 bg-white rounded-xl border border-gray-100 p-3 sm:p-4">
//           <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
//             <h2 className="text-xs sm:text-sm font-semibold text-gray-800">Hourly Success vs Failure</h2>
//             <div className="relative w-full sm:w-auto">
//               <select value={hourlyRange} onChange={e => setHourlyRange(e.target.value)}
//                 className="w-full appearance-none pl-2.5 sm:pl-3 pr-6 sm:pr-6 py-1 text-[11px] sm:text-xs text-gray-600 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none cursor-pointer">
//                 <option>Today</option>
//                 <option>Yesterday</option>
//               </select>
//               <svg className="absolute right-1.5 top-1/2 -translate-y-1/2 w-2.5 h-2.5 sm:w-3 sm:h-3 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
//               </svg>
//             </div>
//           </div>
...
//           <div className="h-[160px] sm:h-[188px] w-full">
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart data={hourlyData} margin={{ top: 5, right: 5, bottom: 0, left: -20 }} barCategoryGap="25%">
//                 <CartesianGrid strokeDasharray="3 3" stroke="#f3f4f6" vertical={false} />
//                 <XAxis dataKey="hour" tick={{ fontSize: 8, fill: "#9ca3af" }} axisLine={false} tickLine={false} interval={1} />
//                 <YAxis tick={{ fontSize: 8, fill: "#9ca3af" }} axisLine={false} tickLine={false}
//                   tickFormatter={v => v >= 1000 ? `${v / 1000}K` : v} width={25} />
//                 <Tooltip content={<BarTooltip />} />
//                 <Bar dataKey="success" fill="#16a34a" radius={[2, 2, 0, 0]} name="Success" maxBarSize={12} />
//                 <Bar dataKey="failure" fill="#dc2626" radius={[2, 2, 0, 0]} name="Failure" maxBarSize={12} />
//               </BarChart>
//             </ResponsiveContainer>
//           </div>

//           <button className="mt-2 flex items-center gap-1 text-[11px] sm:text-xs text-blue-600 font-medium hover:underline ml-auto">
//             View Hourly Report
//             <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
//             </svg>
