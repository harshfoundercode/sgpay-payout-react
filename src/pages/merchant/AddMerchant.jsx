...
// // ── Updated UploadField with file management ──
...
//             </svg>
//             <span className="text-[10px] sm:text-xs text-green-700 truncate max-w-[100px]">
//               {displayFileName}
//             </span>
//             {displayFileSize && (
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={r.label} className="flex items-center justify-between py-1 border-b border-gray-50 last:border-0">
                      ...
                      <span className="text-[11px] sm:text-xs font-medium text-gray-700 text-right max-w-[100px] truncate" title={r.value}>
                        {r.value}
                      </span>
                    </div>
                  ))}
