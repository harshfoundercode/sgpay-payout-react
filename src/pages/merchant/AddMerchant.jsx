...
// ── Main Component ────────────────────────────────────────────────────────────
export default function CreateMerchantPage({ onBack }) {
  // ── Form State ──
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div>
          <p className="text-xs text-gray-400 mb-0.5">
            Merchants <span className="mx-1">›</span> <span className="text-gray-600">Create Merchant</span>
          </p>
      ...
      <div className="pt-1.5">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    suffix={
                      <button onClick={() => setShowPass(!showPass)} className="text-gray-400 hover:text-gray-600">
                        {showPass
            ...
            <SectionCard number="4" title="API Configuration">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input readOnly type={showApiKey ? "text" : "password"} value={apiKey || "Auto generated"}
                    ...
                    <button onClick={() => setApiKey(genKey())}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input readOnly type="password" value={secretKey || "Auto generated"}
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-400 bg-gray-50 outline-none pr-16" />
                      <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1.5">
                    ...
                    <button onClick={() => setSecretKey(genKey(40))}
                      className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg whitespace-nowrap transition-colors">
                      Generate Secret Key
                    </button>
                  </div>
                  ...
                  <div className="flex gap-6 mt-1">
                    {["yes", "no"].map(v => (
                      <label key={v} className="flex items-center gap-2 cursor-pointer">
                        <div onClick={() => setForm(f => ({ ...f, enableWebhook: v }))}
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3 items-end">
                  <div>
                    ...
                    <Select value={form.settlementCycle} onChange={set("settlementCycle")}
                      options={["Instant", "T+1", "T+2", "T+3", "Weekly"]} placeholder="" />
                  </div>
                  <div>
                    <Label>Auto Settlement</Label>
                    <label className="flex items-center gap-2 cursor-pointer mt-1">
                      <div onClick={() => setForm(f => ({ ...f, autoSettlement: !f.autoSettlement }))}
                ...
                <div className="space-y-2.5 mt-2">
                  {[
                    ...
                    <label key={opt.val} className="flex items-center gap-2.5 cursor-pointer">
                      <div onClick={() => setForm(f => ({ ...f, merchantStatus: opt.val }))}
        ...
        <div className="mt-5 bg-white border border-gray-200 rounded-xl px-5 py-3.5 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-2.5">
            <button
              onClick={() => setForm({ merchantName:"",businessName:"",email:"",mobile:"",password:"",confirmPassword:"",businessType:"",gst:"",pan:"",websiteUrl:"",businessAddress:"",city:"",state:"",pincode:"",accountHolder:"",bankName:"",accountNumber:"",confirmAccount:"",ifsc:"",branchName:"",webhookUrl:"",enableWebhook:"yes",minPayout:"1",maxPayout:"50,000",dailyLimit:"10,00,000",monthlyLimit:"1,00,00,000",settlementCycle:"Instant",autoSettlement:true,merchantStatus:"active" })}
            ...
            <button
              onClick={() => alert("Merchant created successfully!")}
