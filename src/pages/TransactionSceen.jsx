...
//     );
// }
// src/pages/TransactionSceen.jsx
    ...
    return (
        <div className="p-3 sm:p-0">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-100 p-3 sm:p-4 mb-3 sm:mb-4">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    <input 
                        className="px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-200 rounded-lg text-[11px] sm:text-xs w-28 sm:w-36 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 placeholder:text-gray-400" 
                    ...
                    <input 
                        ...
                        className="px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-200 rounded-lg text-[11px] sm:text-xs flex-1 min-w-[200px] focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 placeholder:text-gray-400" 
                        placeholder="Transaction ID / Order ID / UTR / Ref No." 
                    />
                    <div className="flex gap-2 ml-auto w-full sm:w-auto mt-2 sm:mt-0">
                        <button 
                            onClick={() => { setSearchTerm(""); setActiveTab("all"); setDateRange(null); }}
