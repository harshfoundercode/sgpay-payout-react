...
//     // Handle back button - navigate to payout-apis
//     const handleBack = () => {
//         if (onBack) {
//             onBack();
//         } else {
...
function StatusBadge({ status, size = "sm" }) {
    return (
        <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full font-semibold ${size === "sm" ? "text-xs" : "text-sm"} ${STATUS_STYLES[status] || "bg-gray-100 text-gray-600"}`}>
            {status}
        </span>
    );
}
        ...
        <div className="min-h-screen text-sm">
            ...
            <div className="flex items-start justify-between mb-5">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2.5 text-xs font-semibold transition-colors shadow-sm">
                        Actions <ChevronDown size={14} />
                    </button>
                </div>
            </div>
                ...
                <div className="flex items-start gap-5">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-700 font-medium mt-1">{p.subtitle}</p>
                            <div className="mt-4 space-y-3 text-sm">
                                <div className="grid grid-cols-[90px_10px_1fr] gap-2">
                                    <span className="text-gray-500 text-xs font-semibold">Provider Type</span>
                                    <span className="text-gray-300">:</span>
                                    <span className="font-medium text-gray-800 text-xs">{p.providerType}</span>
                                </div>
                                <div className="grid grid-cols-[90px_10px_1fr] gap-2">
                                    <span className="text-gray-500 text-xs font-semibold">Priority</span>
                                    <span className="text-gray-300">:</span>
                                    <span className="font-medium text-gray-800 text-xs">{p.priority}</span>
                                </div>
                            </div>
                        </div>
                    </div>
